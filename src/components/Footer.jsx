...
export default function Footer() {
  return (
    <footer className="relative border-t border-white/5 mt-10">
      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl my-10 lg:my-14 p-8 lg:p-12 border border-emerald-500 bg-gradient-to-br from-emerald-500 via-emerald-500/3 to-transparent">
  ...
  Need care now? Talk to a human.
              ...
              <p className="mt-2 text-[14px] md:text-[15px] text-black-600">
      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8 pb-10 grid md:grid-cols-12 gap-8">
        <div className="md:col-span-5">
          ...
          <p className="mt-4 text-[14px] text-black max-w-sm leading-relaxed">
        ...
        <div className="md:col-span-3">
          <p className="text-[12px] uppercase tracking-[0.14em] font-bold text-black-500">
            Services
          </p>
          <ul className="mt-3 space-y-2 text-[13px] text-black-500">
